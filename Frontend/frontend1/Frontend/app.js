...
function selectRole(roleName) {
    if (roleName === 'Farmer') {
        ...
        window.location.href = 'equipmentOwner/equipment_dashboard.html';
    }
}
...
function selectRole(roleName) {
    ...
    else if (roleName === 'Equipment Owner') window.location.href = 'equipmentOwner/equipment_dashboard.html';
}
